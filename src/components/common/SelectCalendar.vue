			...
			<CalendarGrid v-for="month in grid" :key="month.value.toString()">
				...
				<CalendarGridBody>
					<CalendarGridRow
						...
						class="mt-2 w-full">
						<CalendarCell
							class="[&:has([data-selected])]:bg-white"
							v-for="weekDate in weekDates"
							:key="weekDate.toString()"
							:date="weekDate">
							<CalendarCellTrigger
								class="rounded-full data-[outside-view]:hover:text-white data-[selected]:bg-blue-500 data-[selected]:focus:bg-blue-500 data-[selected]:hover:bg-blue-500 hover:bg-blue-500 hover:text-white"
								:day="weekDate"
								:month="month.value" />
						</CalendarCell>
					</CalendarGridRow>
