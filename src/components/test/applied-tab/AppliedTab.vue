...
import AppliedPassModal from './AppliedPassModal.vue';
...
const table = useVueTable({
	get data() {
		return recruitmentStore.applicantAppliedStage;
	},
...
onBeforeMount(() => {
	recruitmentStore.getAppliedStageData();
});
</script>
<template>
	...
	<AppliedPassModal
		:open="isOpenDialogPass"
		@update:open="handleCloseDialogPass"
		:data="dataSent" />
